...
const Menubar = () => {
  ...
  return (
    <div>
      <Navbar fixed="top" collapseOnSelect expand="lg" className="pt-5 px-5" bg="white" variant="light">
        <Navbar.Brand>
          <img className="me-md-5 me-0" src={logo} alt="" />
        </Navbar.Brand>
            ...
            <Nav>
              {user?.email ? (
                <div className="menu-item align-items-center">
                  <div className="me-2">
                    {" "}
                    <NavDropdown className="fs-5" title="Dashboard" id="basic-nav-dropdown">
                      <NavDropdown.Item>
                        <NavLink
                          activeStyle={{
                            fontWeight: "bold",
